...
function [Z_out,z_out,Pp_out,Ps_out,Pout_out,t_out,lambda_s_out,inv_out] = YDF_FTBS_CW_0(EDFA_N0,EDFA_L,EDFA_w,NA,lambda_p,tauf,L,iso_l_in,cou_l_in,aom_l_in,wdm_l_in,Ppf,Ppb,T,q,R,N,file_path)
