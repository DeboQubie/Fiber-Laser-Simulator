...
function FTBS_rep_4_3_5_err_avgSpectrum_0(initial_condition)
...
Data = dlmread("D:\Deepa madam's project\Erbium codes\Q-switchedLaser_Codes\EDFAmplifier_Laser_SteadyState\HG980.csv");
...
if initial_condition == "Open"
    ...
    [pf,Z,Spectrum_out,Ps_out,lambda_s,ps,n1,Bp,Bs,lams] = EDF_Amplifier_0(EDFA_L,dz,EDFA_N0,NA,nf,EDFA_w,0,EDFA_lam_p,1501e-9,1600e-9,1e-9,t_f,wdm_l*4.343,iso_l*4.343,200,0,"D:\Deepa madam's project\Erbium codes\Q-switchedLaser_Codes\EDFAmplifier_Laser_SteadyState\HG980.csv","y");
else
