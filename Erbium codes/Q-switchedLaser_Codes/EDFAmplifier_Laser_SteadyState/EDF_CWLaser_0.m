...
function [Z,lambda_s,Spectrum_out,Gain_out,Pp_out,Ps_out,fiber,pf,ps,N1,bp,bs] = EDF_CWLaser_0(L,N0,NAs,neff,rs,alpha,lambda_p,lambda_s_start,lambda_s_stop,lambda_s_step,tauf,wdm_p_in,iso_l_in,cou_l_in,c_out_in,wdm_l_in,aom_l_in,c_l_in,Pp,file_name,inserting_data,dz)
