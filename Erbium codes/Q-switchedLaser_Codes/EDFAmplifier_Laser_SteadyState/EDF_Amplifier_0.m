...
function [Pp_out,Z,Spectrum_out,Ps_out,lambda_s,Ps,N1,bp,bs,lams] = EDF_Amplifier_0(L,dz,N0,NAs,neff,rs,alpha,lambda_p,lambda_s_start,lambda_s_end,lambda_s_step,tauf,wdm_l_in,iso_l_in,Pp_in,Ps_in,file_path,inserting_data)
...
disp(['size of Lambda_s = ',size(lambda_s),' '])
