...
dl = 1;             % ASE wavelength separation in nm
...
%     tic
    PP = Pp;PS = Ps;n1 = N1;
    [Z,Sol] = ode45(@CW_nlam,z,[P_in S_in],step,Input,fiber);
...
% subplot(224),
plot(lam_s*1e9,10*log10(Spectrum*1e3)),xlabel('Wavelength (nm)'),ylabel('Power (dBm)'),title('Spectrum'),grid on
